...
menu:
  leftnav:
    identifier: 28a97481629543ec71e8774748529f30
    name: Projects
    weight: 60
title: Projects
type: course
uid: 28a97481629543ec71e8774748529f30
...
3.  **Proposal**: A crisp one-page write-up that should contain the following items. Three hard copies per group.
    ...
    *   A clear statement of your research methodology, i.e., how are you going to solve the problems you have raised and motivated in the previous paragraph?  
        ...
         
    *   A statement of plan and schedule, to convince us (and yourself!) that you can complete this by the end of the term (exact due dates are [here]({{< baseurl >}}/sections/calendar)).  
