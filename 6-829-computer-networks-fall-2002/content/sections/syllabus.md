...
menu:
  leftnav:
    identifier: 8b1798a9fb3fff2e8c3990bb0fb1bfe1
    name: Syllabus
    weight: 10
title: Syllabus
type: course
uid: 8b1798a9fb3fff2e8c3990bb0fb1bfe1
...
[Topics]({{< baseurl >}}/sections/calendar) include internetworking philosophies, unicast and multicast routing, congestion control, network quality of service, mobile networking, router architectures, network-aware applications, content dissemination systems, network security, and performance issues. [Material]({{< baseurl >}}/sections/readings) for the course will be drawn from research papers, industry white papers, and [Internet RFCs](http://www.ietf.org/rfc.html).
